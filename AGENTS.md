...
- Sets up Docker DNS, installs `lab` CLI, creates `ollama`/`cloudflared` aliases
...
- **external/** - Third-party apps (n8n, ollama)
...
4. Access: http://n8n.local (local) or https://n8n.mlovera.dev (production)
